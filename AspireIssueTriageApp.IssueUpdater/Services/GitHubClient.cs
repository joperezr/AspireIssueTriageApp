...
public class GitHubService
{
    ...
    /// <summary>
    /// Retrieves all open issues for a specified repository.
    /// </summary>
    /// <param name="repositoryOwner">The owner of the repository.</param>
    /// <param name="repositoryName">The name of the repository.</param>
    /// <returns>A list of open issues for the repository.</returns>
    public async Task<IReadOnlyList<Issue>> GetAllOpenIssuesForRepository(string repositoryOwner, string repositoryName)
    {
        var request = new RepositoryIssueRequest
        {
            State = ItemStateFilter.Open
        };
        return await _client.Issue.GetAllForRepository(repositoryOwner, repositoryName, request);
    }
